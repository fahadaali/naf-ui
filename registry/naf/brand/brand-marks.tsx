 ...
 * --brand-on-color.
 *
 * لماذا هنا وليست في Lucide: النسخة 1.x حذفت كل أيقونات العلامات
 * التجارية بلا بديل — Facebook و Instagram و Youtube و Linkedin وغيرها.
 * فمن يستهلك السجلّ على تثبيته المعتمد لا يجدها إلا هنا.
 *
...
/* بيسكامب — أداة إدارة المشاريع. ليست منصةً اجتماعية كأخواتها أعلاه،
   لكنها علامة مملوكة لطرف آخر يسري عليها ما يسري عليهنّ: لا تُقلب، ولا
   تُلوَّن بألوان الثيم، وخلفيتها ‎--brand-basecamp‎ ومقدّمتها
   ‎--brand-on-color‎. والمسار من simple-icons كأخواته — من هناك لا من
   الذاكرة ولا من بحث صور. */
export const BasecampMark = mark(
  "BasecampMark",
